      ...
      >
        ...
        >
          <button
            onClick={() =>
              setViewDate(
                new Date(calendarData.year, calendarData.month - 1, 1)
              )
            }
            style={{
              border: "none",
          ...
          >
            {calendarData.monthShort} {calendarData.year}
          </span>
          <button
            onClick={() =>
              setViewDate(
              ...
              >
                <div
                  style={{
                    ...
                    padding: "22px",
                    backgroundColor:
                      draggedIndex === idx ? "#F0F0F0" : "#FBFBFB",
                    borderRadius: "28px",
                    border: "1px solid #F0F0F0",
                  }}
                >
                  ...
                  <div
                    onClick={(e) => {
                      ...
                      if (window.confirm("Delete?"))
                        setHabits(habits.filter((i) => i.id !== h.id));
                    }}
                  >
                    <TrashIcon />
                  </div>
              ...
              {presetColors.map((c) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: c,
                    cursor: "pointer",
                    border: newColor === c ? "3.5px solid #1A1A1A" : "none",
                    boxSizing: "border-box",
                  }}
                />
              ))}
              ...
              <button
                onClick={() => {
                  if (newName) {
                    setHabits([
                      ...habits,
                      { id: Date.now(), name: newName, color: newColor },
                    ]);
